...
export default async function AdminLessonsPage() {
  ...
  return (
    <AppShell profile={profile}>
      ...
      <form action="/api/admin/bunny-transfer-next" method="post" className="mt-4">
        <button type="submit" className="rounded-xl bg-amber-500 px-4 py-2 text-sm font-black text-slate-950 hover:bg-amber-400">
          بدء نقل الدرس التالي إلى Bunny
        </button>
      </form>
      <AdminLessonsManager
